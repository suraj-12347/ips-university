...
const nextRef = useRef(null);
  ...
  return (
  <>
    <section className="w-full bg-[#ececec] py-16 mt-20 relative overflow-hidden">
      ...
      {/* Header */}
      <div className="flex items-center justify-between px-6 md:px-12 mb-10 relative z-40">

        <div>
          <p className="text-[var(--grass)] text-sm font-semibold tracking-[3px] uppercase ">
            Campus Life
          </p>
