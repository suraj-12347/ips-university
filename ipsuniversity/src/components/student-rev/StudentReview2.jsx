  ...
  return (
    ...
    >
      ...
      <div className="text-center max-w-xl mx-auto">
        <p className="text-white/80 tracking-[5px] uppercase text-xs md:text-sm font-medium">
          Students Voices
        </p>

        <h2 className="mt-2 md:mt-4 text-xl md:text-4xl font-semibold text-[var(--white)] leading-snug md:leading-tight">
