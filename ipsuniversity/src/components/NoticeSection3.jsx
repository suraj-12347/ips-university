...
const NewsNoticeSection3 = () => {
  ...
  return (
    <section
      className="w-full py-10 px-3 md:px-5 relative overflow-hidden mt-10"
      style={{
        background:
    ...
    >
      {/* Background Rings */}
      <div className="absolute -right-40 -top-40 pointer-events-none opacity-60">
        <DotedRing height={450} width={450} />
      </div>

      <div className="absolute -left-40 bottom-0 pointer-events-none opacity-60">
        <DotedRing height={450} width={450} />
      </div>

      {/* Main Container */}
      <div className="max-w-[1100px] mx-auto flex flex-col lg:flex-row gap-5 justify-center items-stretch relative z-10">
        ...
        >
          ...
          <div className="flex items-start justify-between gap-3 flex-wrap">
            ...
            <h2 className="text-lg md:text-xl font-bold text-[var(--forest)]">
              News & Events
            </h2>
          ...
          {/* News List */}
          <div className="flex-1 overflow-y-auto mt-4 pr-2 scrollb">
              ...
              {filteredNews.map((item, index) => (
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-700 leading-5 text-[12px] md:text-[13px]">
                      {item.text}
                    </p>
...
export default NewsNoticeSection3;